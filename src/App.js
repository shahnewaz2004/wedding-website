...
function App() {
  ...
  return (
    <div>
      <div className={`${hide ? 'opacity-0' : 'opacity-100'} transition duration-500 bg-white z-[1000] pointer-events-none flex absolute top-0 items-center justify-center  w-screen h-screen`}>
